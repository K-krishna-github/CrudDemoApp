...
namespace CrudDemoApp.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("getemployees")]
        public async Task<ActionResult<PaginationEntityDto<EmployeeDto>>> GetEmployees(string? searchtext, int skip = 0, int maxresults = 10) => await emprepos.GetEmployees(searchtext,skip,maxresults);
